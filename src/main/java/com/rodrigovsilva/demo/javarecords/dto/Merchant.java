...
public record Merchant(@NotNull @Size(min = 5) String username, @NotNull @Email String email, Set<Website> websites) {

    public Merchant(String username, String email) {
        this(username, email, Collections.emptySet()); // initialize with an immutable empty set
    }

    public Merchant(String username, String email, Set<Website> websites) {
